...
; require("/Users/jghazally/Documents/Python/agency-io/src/static/bower_components/underscore/underscore.js");
...
(function(factory) {
  ...
  // Next for Node.js or CommonJS. jQuery may not be needed as a module.
    ...
    try { $ = (typeof window !== "undefined" ? window['$'] : typeof global !== "undefined" ? global['$'] : null); } catch(e) {}
...
},{"/Users/jghazally/Documents/Python/agency-io/src/static/bower_components/underscore/underscore.js":3}],2:[function(require,module,exports){
(function (global){
; var __browserify_shim_require__=require;(function browserifyShim(module, exports, require, define, browserify_shim__define__module__export__) {
...
},{"../models/group":7,"backbone":1}],5:[function(require,module,exports){
var Backbone = require('backbone');
...
},{"../models/person":8,"backbone":1}],6:[function(require,module,exports){
(function (global){
...
$(function() {
	...
	// app.people.add({firstName: 'Arthur', lastName: 'Guigand'});
	// app.people.add({firstName: 'Jeff', lastName: 'Ghazally'});
	// app.people.add({firstName: 'Martin', lastName: 'Hipp'});
	// app.people.add({firstName: 'Rachael', lastName: 'Short'});
	// app.people.add({firstName: 'Rebecca', lastName: 'Jones'});
	// app.people.add({firstName: 'Renee', lastName: 'Pearson'});
	// app.people.add({firstName: 'Ryan', lastName: 'Christie'});
	// app.people.add({firstName: 'Simon', lastName: 'White'});
});

}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
},{"./views/app":9}],7:[function(require,module,exports){
var Backbone = require('backbone');
...
var AppView = Backbone.View.extend({
	...
	filterGroup: function(group) {
		...
		// var groupPeople = this.people.group(group);
...
},{"../collections/groups":4,"../collections/people":5,"./person":10,"backbone":1}],10:[function(require,module,exports){
(function (global){
var $ = (typeof window !== "undefined" ? window['$'] : typeof global !== "undefined" ? global['$'] : null);
var _ = require('underscore');
var Backbone = require('backbone');
...
},{"backbone":1,"hammer":2,"underscore":3}]},{},[6]);
